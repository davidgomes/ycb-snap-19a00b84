defmodule PrismTest do
  ...
  test "upward refraction two hits" do
    prisms = [%{id: 1, angle: 0, x: 10, y: 10}, %{id: 2, angle: 90, x: 10, y: 0}]
    start = %{angle: 0, x: 0, y: 0}
  ...
  test "downward refraction two hits" do
    prisms = [%{id: 1, angle: -90, x: 10, y: 0}, %{id: 2, angle: 0, x: 10, y: -10}]
    start = %{angle: 0, x: 0, y: 0}
  ...
  test "same prism twice" do
    prisms = [%{id: 2, angle: 0, x: 10, y: 0}, %{id: 1, angle: -180, x: 20, y: 0}]
    start = %{angle: 0, x: 0, y: 0}
