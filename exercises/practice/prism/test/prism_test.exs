defmodule PrismTest do
  ...
  test "zero prisms" do
    ...
    prisms = []
    assert Prism.find_sequence(start, prisms) == []
  end
  ...
  test "one prism one hit" do
    ...
    assert Prism.find_sequence(start, prisms) == [1]
  end
  ...
  test "upward refraction two hits" do
    ...
    assert Prism.find_sequence(start, prisms) == [2, 1]
  end
  ...
  test "downward refraction two hits" do
    ...
    assert Prism.find_sequence(start, prisms) == [1, 2]
  end
  ...
  test "same prism twice" do
    ...
    assert Prism.find_sequence(start, prisms) == [2, 1, 2]
  end
  ...
  test "simple path" do
    ...
    assert Prism.find_sequence(start, prisms) == [2, 1, 3]
  end
  ...
  test "multiple prisms floating point precision" do
    ...
    assert Prism.find_sequence(start, prisms) == [7, 30, 16, 28, 13, 22, 23, 10, 9, 24, 25, 38, 29, 4, 35, 21, 5, 20, 11, 1, 33, 26, 32, 6, 15, 17, 2, 14, 27, 34, 37, 31, 36, 18, 19, 8, 3, 12]
  end
  ...
  test "complex path with multiple prisms floating point precision" do
    ...
    assert Prism.find_sequence(start, prisms) == [43, 44, 66, 45, 52, 35, 49, 13, 3, 69, 46, 28, 20, 11, 24, 38, 19, 42, 15, 10, 63, 25, 59, 1, 6, 2, 4, 67, 22, 29, 65, 64, 12, 47, 54, 68, 23, 75, 8, 26, 18, 9, 60, 17, 31, 7, 70, 40, 5, 51, 61, 55, 57, 14, 58, 76, 56, 16, 21, 30, 73, 62, 74, 41, 39, 36, 50, 37, 33, 71, 72, 34, 32, 27, 48, 53]
  end
end
