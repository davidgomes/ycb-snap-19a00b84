...
| [SmartEngineNotConfigured](https://hexdocs.pm/oban_doctor/ObanDoctor.Check.Config.SmartEngineNotConfigured.html) | Detects Oban instances not using the Smart engine when Oban Pro is installed  |
