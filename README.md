...
Otherwise, the `secret_key_base` can usually be found in the Rails' `secrets.yml` file. It should be copied to Phoenix's `config.exs` file. There should already be a key named like that and you should override it.
