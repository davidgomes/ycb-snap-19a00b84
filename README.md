...
Any option accepted by `Oban.Job.new/2`, nested under the `:oban` key. Common ones:
...
- `meta` - Arbitrary job metadata

Per-handler values override the global defaults. Options you omit keep the global value.
