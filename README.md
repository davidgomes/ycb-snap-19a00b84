...
Register the bundled JS hooks in `assets/js/app.js` (needed for the password/copyable/clearable inputs, the chat components and the dropdown's upward flip — the rest of the library is CSS + LiveView.JS only):
