...
* No notification listener is started, new jobs are picked up every `poll_interval` or when workers ask for more demand.
* The `:notify` option of a job is ignored.
