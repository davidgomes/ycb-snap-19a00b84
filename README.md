...
| [SmartEngineNotConfigured](https://hexdocs.pm/oban_doctor/ObanDoctor.Check.Config.SmartEngineNotConfigured.html) | Detects Oban Pro projects with instances not using `Oban.Pro.Engines.Smart` |
