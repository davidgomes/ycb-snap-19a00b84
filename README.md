...
This library also includes the following `mix` tasks for Phoenix 1.3:
...
For projects using the older `web/` directory structure, the equivalent
`mix phoenix.gen.html.slime` and `mix phoenix.gen.layout.slime` tasks are
still available.
