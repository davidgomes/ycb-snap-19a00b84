...
This library also includes `mix` tasks for Phoenix 1.3 projects:
...
For projects using the legacy Phoenix 1.2 directory structure, the
`mix phoenix.gen.html.slime` and `mix phoenix.gen.layout.slime` tasks are still
available and generate files under `web/`.
