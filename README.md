...
Oban job options (under `:oban` key) are merged over the global options. Any option
accepted by `Oban.Job.new/2` is supported, for example:
...
- `unique`, `schedule_in`, ... - Passed through to Oban as-is
