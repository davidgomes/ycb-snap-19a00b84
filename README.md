...
| [SmartEngineNotConfigured](https://hexdocs.pm/oban_doctor/ObanDoctor.Check.Config.SmartEngineNotConfigured.html) | Detects Oban Pro users not using Smart Engine                                 |
