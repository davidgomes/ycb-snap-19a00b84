...
| [SmartEngineNotConfigured](https://hexdocs.pm/oban_doctor/ObanDoctor.Check.Config.SmartEngineNotConfigured.html) | Detects when Oban Pro is installed but SmartEngine is not configured          |
