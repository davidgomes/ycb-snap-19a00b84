...
// Restore the saved theme once the body exists. The script is inlined in <head>,
// so document.body is not available yet, and phx-hook on <body> is outside the LiveView.
