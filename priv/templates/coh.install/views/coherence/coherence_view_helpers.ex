defmodule <%= web_base %>.Coherence.ViewHelpers do
  ...
  """
  def recover_link_text, do: dgettext("coherence", @recover_link_text)

  @doc """
  Get the default text for the Send an unlock email link.
  """
  def unlock_link_text, do: dgettext("coherence", @unlock_link_text)

  @doc """
  Get the default text for the Need An Account? link.
  """
  def register_link_text, do: dgettext("coherence", @register_link_text)

  @doc """
  Get the default text for the Invite Someone link.
  """
  def invite_link_text, do: dgettext("coherence", @invite_link_text)

  @doc """
  Get the default text for the Resend confirmation email link.
  """
  def confirm_link_text, do: dgettext("coherence", @confirm_link_text)

  @doc """
  Get the default text for the Sign In link.
  """
  def signin_link_text, do: dgettext("coherence", @signin_link_text)

  @doc """
  Get the default text for the Sign Out link.
  """
  def signout_link_text, do: dgettext("coherence", @signout_link_text)
  ...
  * :register - customize the register link text (#{@register_link_text})
  ...
  ## Examples
      ...
      Generates: #{@recover_link_text}  #{@unlock_link_text} #{@register_link_text} #{@confirm_link_text}

      coherence_links(conn, :new_session, recover: "Password reset", register: false
      Generates: Password reset  #{@unlock_link_text}
