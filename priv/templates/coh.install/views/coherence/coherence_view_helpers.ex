defmodule <%= web_base %>.Coherence.ViewHelpers do
  ...
  * :register - customize the register link text (#{@register_link})
  ...
  def coherence_links(conn, :new_session, opts) do
    recover_link  = Keyword.get opts, :recover, dgettext("coherence", @recover_link)
    unlock_link   = Keyword.get opts, :unlock, dgettext("coherence", @unlock_link)
    register_link = Keyword.get opts, :register, dgettext("coherence", @register_link)
    confirm_link  = Keyword.get opts, :confirm, dgettext("coherence", @confirm_link)
  ...
  def coherence_links(conn, :layout, opts) do
    ...
    signin        = Keyword.get opts, :signin, dgettext("coherence", @signin_link)
    signout       = Keyword.get opts, :signout, dgettext("coherence", @signout_link)
    register      = Keyword.get opts, :register, dgettext("coherence", @register_link)
  ...
  def recover_link(conn, text \\ dgettext("coherence", @recover_link)), do:
  ...
  def register_link(conn, text \\ dgettext("coherence", @register_link)), do:
  ...
  def confirmation_link(conn, text \\ dgettext("coherence", @confirm_link)) do
