defmodule ElixirLS.LanguageServer.Providers.SelectionRanges do
  ...
  # tokenizer-driven token-pair pass. String/heredoc/sigil ranges, which the old special-token pass
  # produced, already come from `ast_node_ranges` (the toxic AST nodes carry `range:`), so they are
  # not reproduced here.
