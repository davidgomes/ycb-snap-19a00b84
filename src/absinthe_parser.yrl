...
OperationDefinition -> DescriptionDefinition OperationType SelectionSet : build_ast_node('OperationDefinition', #{'operation' => extract_atom('$2'), 'selection_set' => '$3', 'description' => '$1'}, extract_location('$2')).
...
OperationDefinition -> DescriptionDefinition OperationType Directives SelectionSet : build_ast_node('OperationDefinition', #{'operation' => extract_atom('$2'), 'directives' => '$3', 'selection_set' => '$4', 'description' => '$1'}, extract_child_location('$2')).
...
OperationDefinition -> DescriptionDefinition OperationType VariableDefinitions SelectionSet : build_ast_node('OperationDefinition', #{'operation' => extract_atom('$2'), 'variable_definitions' => '$3', 'selection_set' => '$4', 'description' => '$1'}, extract_child_location('$2')).
...
OperationDefinition -> DescriptionDefinition OperationType VariableDefinitions Directives SelectionSet : build_ast_node('OperationDefinition', #{'operation' => extract_atom('$2'), 'variable_definitions' => '$3', 'directives' => '$4', 'selection_set' => '$5', 'description' => '$1'}, extract_child_location('$2')).
...
OperationDefinition -> DescriptionDefinition OperationType Name SelectionSet : build_ast_node('OperationDefinition', #{'operation' => extract_atom('$2'), 'name' => extract_binary('$3'), 'selection_set' => '$4', 'description' => '$1'}, extract_location('$2')).
...
OperationDefinition -> DescriptionDefinition OperationType Name VariableDefinitions SelectionSet : build_ast_node('OperationDefinition', #{'operation' => extract_atom('$2'), 'name' => extract_binary('$3'), 'variable_definitions' => '$4', 'selection_set' => '$5', 'description' => '$1'}, extract_location('$2')).
...
OperationDefinition -> DescriptionDefinition OperationType Name Directives SelectionSet : build_ast_node('OperationDefinition', #{'operation' => extract_atom('$2'), 'name' => extract_binary('$3'), 'directives' => '$4', 'selection_set' => '$5', 'description' => '$1'}, extract_location('$2')).
...
OperationDefinition -> DescriptionDefinition OperationType Name VariableDefinitions Directives SelectionSet : build_ast_node('OperationDefinition', #{'operation' => extract_atom('$2'), 'name' => extract_binary('$3'), 'variable_definitions' => '$4', 'directives' => '$5', 'selection_set' => '$6', 'description' => '$1'}, extract_location('$2')).
...
Fragment -> DescriptionDefinition 'fragment' FragmentName 'on' TypeCondition SelectionSet : build_ast_node('Fragment', #{'name' => '$3', 'type_condition' => '$5', 'selection_set' => '$6', 'description' => '$1'}, extract_location('$2')).
...
Fragment -> DescriptionDefinition 'fragment' FragmentName 'on' TypeCondition Directives SelectionSet : build_ast_node('Fragment', #{'name' => '$3', 'type_condition' => '$5', 'directives' => '$6', 'selection_set' => '$7', 'description' => '$1'}, extract_location('$2')).
