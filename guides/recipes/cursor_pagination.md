...
Compound, alias, and custom fields cannot be ordered by at all when using cursor
pagination, since none of them is a plain column value the cursor can compare.
`Flop.validate/2` returns an error naming the fields.
