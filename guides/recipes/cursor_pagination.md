...
Compound, alias and custom fields cannot be used as cursor order fields.
`Flop.validate/2` returns an error naming the fields. Custom fields can still
be used for ordering with offset and page pagination.
