...
* Add support for all `asc`/`desc` sorting order combinations, including `:asc_nulls_first`,
  `:asc_nulls_last`, `:desc_nulls_first` and `:desc_nulls_last`, and paginate correctly through
  `nil` values ([#136](https://github.com/duffelhq/paginator/pull/136))
