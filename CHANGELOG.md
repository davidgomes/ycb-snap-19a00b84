...
* Add support for all asc/desc sorting order combinations, including nullable
  columns (`:asc_nulls_first`, `:asc_nulls_last`, `:desc_nulls_first`,
  `:desc_nulls_last`): ([#136](https://github.com/duffelhq/paginator/pull/136))
