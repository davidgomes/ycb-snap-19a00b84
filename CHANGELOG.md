...
* Add support for the `:on-auto-recover`, `:on-viewport-top` and `:on-viewport-bottom` event directives
* Move form-specific event logic (`phx-trigger-action`) to `surface_form`
