...
- Standardize ClickHouse quoting: string literals now escape single quotes as `\'`, and `json_extract_path/2` always double-quotes path keys like `json."foo"."bar"` https://github.com/plausible/ecto_ch/pull/304
