...
- Standardize quoting: identifiers (including JSON path keys) are always double-quoted and string literals are single-quoted, both escaping backslashes and the delimiter with a backslash https://github.com/plausible/ecto_ch/pull/304
