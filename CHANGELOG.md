...
- Add optional `:before_clean` callback to the ETS and Atomic backends, invoked with the algorithm name and the expired entries right before they are removed during cleanup (#140, #177)
