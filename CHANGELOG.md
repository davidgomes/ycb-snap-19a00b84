...
- Standardize ClickHouse quoting: identifiers and JSON path keys are double-quoted, string literals are single-quoted, and both escape backslashes and their delimiter with a backslash https://github.com/plausible/ecto_ch/pull/304
