...
* Support all asc/desc sorting order combinations: `:asc_nulls_first`, `:asc_nulls_last`,
`:desc_nulls_first` and `:desc_nulls_last` can now be used in `:cursor_fields`, and `NULL`
cursor values are paginated according to the sort order.
([#136](https://github.com/duffelhq/paginator/pull/136))
