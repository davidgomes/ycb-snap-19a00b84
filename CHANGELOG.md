...
- Standardize ClickHouse quoting: identifiers and string literals share one escape-and-wrap helper, and JSON path keys are always double-quoted identifiers https://github.com/plausible/ecto_ch/pull/304
