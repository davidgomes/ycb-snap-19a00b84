...
* Add support for all Ecto sort directions (`:asc_nulls_first`, `:asc_nulls_last`,
  `:desc_nulls_first`, `:desc_nulls_last`) in `:cursor_fields` ([#136](https://github.com/duffelhq/paginator/pull/136))
