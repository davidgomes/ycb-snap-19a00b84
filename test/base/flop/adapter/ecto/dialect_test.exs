defmodule Flop.Adapter.Ecto.DialectTest do
  ...
  describe "null_placement/2" do
    test "follows the direction where it states the placement" do
    ...
    test "follows the database default for a plain direction" do
  ...
  describe "the cursor predicate" do
    ...
    test "reads the placement from the direction where it states one" do
      for repo <- [PostgresRepo, MyXQLRepo, SQLite3Repo] do
