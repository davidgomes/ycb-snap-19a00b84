defmodule Phoenix.LiveViewTest.E2E.Issue2835Live do
  ...
  def handle_progress(:files, %{done?: true} = entry, socket) do
  ...
  def handle_progress(:files, _entry, socket), do: {:noreply, socket}
  ...
  def render(assigns) do
    ...
    <div id="issue-2835">
      ...
      <p :for={error <- upload_errors(@uploads.files)} class="upload-error">{inspect(error)}</p>
