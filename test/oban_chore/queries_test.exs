defmodule ObanChore.QueriesTest do
  ...
  test "list_job_history/2 generates the correct Ecto query", %{oban_name: oban_name} do
    ObanChore.list_job_history(SomeWorker, oban_name: oban_name)
  ...
  test "list_job_history/2 respects the :limit option", %{oban_name: oban_name} do
    ObanChore.list_job_history(SomeWorker, oban_name: oban_name, limit: 5)
