defmodule PlugRailsCookieSessionStoreTest do
  ...
  setup do
    conn = conn(:get, "/")
    opts = Plug.Session.init(store: CookieStore, key: "foobar", secret: @valid_secret)
