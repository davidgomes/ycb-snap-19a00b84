...
describe("PetalDataTable", () => {
  ...
  it("filter apply replaces this field's committed entry and patches", () => {
    ...
    // closing is the form's phx-submit (LiveView.JS) - a style write here
    // would be undone by the next patch
  ...
  it("event mode: filter submits are LiveView's - no interception, no navigation", () => {
    const { el, patched } = mountBase({});
