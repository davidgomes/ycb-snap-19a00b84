defmodule ObanEvents.DispatchWorkerTest do
  ...
  defmodule TestHandler do
    ...
    def handle_event(:test_event, %Event{data: %{"action" => "metadata"}} = event) do
  ...
  describe "perform/1" do
    ...
    test "passes event metadata to handler in an Event struct" do
      job_args = %{
        "event" => "test_event",
        "handler" => "Elixir.ObanEvents.DispatchWorkerTest.TestHandler",
    ...
    test "defaults missing metadata to nil" do
      job_args = %{
        "event" => "test_event",
        "handler" => "Elixir.ObanEvents.DispatchWorkerTest.TestHandler",
        "data" => %{"action" => "metadata"}
