defmodule MyApp.Pet do
  ...
  @derive {
    ...
    sortable: [:name, :age, :owner_name, :owner_age, :reverse_name],
    max_limit: 1000,
    adapter_opts: [
      compound_fields: [
      ...
      custom_fields: [
        ...
        reverse_name: [
          ...
          order: {__MODULE__, :reverse_name_order, [source: :name]},
          ecto_type: :string
        ]
      ]
    ]
  ...
  def reverse_name_order(_query, direction, opts) do
    source = Keyword.fetch!(opts, :source)
    send(self(), {:order, direction, opts})
