defmodule ObanDoctor.Check.Worker.UniquenessMissingStatesTest do
  ...
  describe "run/1" do
    ...
    test "does not flag workers using :incomplete named state group" do
      workers = [
        %{
    ...
    test "does not flag workers using :successful named state group" do
      workers = [
        %{
    ...
    test "does not flag workers using :scheduled named state group" do
      workers = [
        %{
