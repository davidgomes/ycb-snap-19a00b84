defmodule ObanDoctor.Check.Worker.UniquenessMissingStatesTest do
  ...
  describe "run/1" do
    ...
    test "does not flag workers using the :incomplete named group" do
      workers = [
        %{
    ...
    test "does not flag workers using the :scheduled named group" do
      workers = [
        %{
    ...
    test "does not flag workers using the :successful named group" do
      workers = [
        %{
