defmodule NewsletterWeb.SubscriberControllerTest do
  ...
  describe "create subscriber" do
    ...
    test "does not send a welcome email when data is invalid", %{conn: conn} do
      post(conn, Routes.subscriber_path(conn, :create), subscriber: @invalid_attrs)
  ...
  describe "update subscriber" do
    ...
    test "redirects when data is valid", %{conn: conn, subscriber: subscriber} do
      conn =
        put(conn, Routes.subscriber_path(conn, :update, subscriber), subscriber: @update_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn, subscriber: subscriber} do
      conn =
        put(conn, Routes.subscriber_path(conn, :update, subscriber), subscriber: @invalid_attrs)
