    ...
    assert TestRepo.all(
             from s in SemiStructured,
               select: %{
                 ...
                 edge_keyword: json_extract_path(s.json, ["edge cases", "FROM"]),
                 edge_lowercase_keyword: json_extract_path(s.json, ["edge cases", "select"]),
             ...
             %{
               ...
               edge_lowercase_keyword: "lowercase keyword",
               bracket_name: "Test"
             }
           ]
  end
