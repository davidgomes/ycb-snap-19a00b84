defmodule LivebookWeb.Hub.Teams.DeploymentGroupAgentComponent do
  ...
  # Escapes a value so it is safe to interpolate inside a double-quoted
  # shell string (guards against characters like ", \, $ and `).
