defmodule Canary.Utils do
  ...
  @doc """
  Get the resource name from the options as an atom, pluralized for the `:index` action.
  ...
  @doc """
  Get the actions that don't require a resource id, including the `:non_id_actions` option
  """
    ...
    if Keyword.has_key?(opts, :persisted) do
      IO.warn(
        "The `:persisted` option is deprecated and will be removed in Canary 2.1.0. " <>
          "Use `:required` instead. Check the upgrade guide for more information."
      )
    end
