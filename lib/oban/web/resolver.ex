defmodule Oban.Web.Resolver do
  ...
  * [Default Refresh](#c:resolve_refresh/1)—Set the default refresh interval for new sessions.
  ...
  @doc """
  Customize the formatting of received signal payloads wherever they are displayed.

  Signals are delivered to jobs parked with `Oban.Pro.Worker.await_signal/1`. This callback is
  ...
  * `:update_crons`
  ...
  @doc """
  Decode a signal payload from a base64 binary into proper terms.

  Signals are encoded the same way as recorded output, and decoding applies the same `:safe`
  flag by default. See `decode_recorded/2` for details.
