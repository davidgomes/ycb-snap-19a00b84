defmodule ObanDoctor.Check.Worker.StateGroupUsage do
  ...
  state groups, which are safe to use and are not flagged by this check. See the
  [`Oban.Job.unique_states/1`](https://hexdocs.pm/oban/Oban.Job.html#unique_states/1)
  docs and the [Unique Jobs guide](https://hexdocs.pm/oban/unique_jobs.html) for
  the full list of named state groups.
