defmodule ObanDoctor.Check.Worker.StateGroupUsage do
  ...
  Other named state groups (`:incomplete`, `:scheduled`, and `:successful`) exclude
  `:cancelled` and `:discarded`, so they are not flagged by this check.
  ...
  Good - the `:incomplete` group allows re-enqueueing after completion:
