defmodule ErrorTracker.Web.Layouts do
  ...
  def navbar(assigns) do
    ~H"""
    <nav class="border-gray-400 bg-white shadow-sm dark:bg-gray-900 dark:shadow-none">
  ...
  defp navbar_item_class do
    "whitespace-nowrap flex-0 block py-2 px-3 rounded-lg text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 md:hover:bg-transparent md:border-0 md:hover:text-sky-500"
  end
end
