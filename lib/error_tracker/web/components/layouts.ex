defmodule ErrorTracker.Web.Layouts do
  ...
  def navbar(assigns) do
    ~H"""
    <nav class="border-gray-200 bg-gray-100 dark:border-gray-400 dark:bg-gray-900">
      <div class="container flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-main">
          <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-200 bg-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-gray-100 dark:border-gray-400 dark:bg-gray-900 dark:md:bg-gray-800">
  ...
  def navbar_item(assigns) do
    ...
    <li>
      <a
        href={@to}
        class="whitespace-nowrap flex-0 block py-2 px-3 rounded-lg text-gray-900 hover:text-gray-900 hover:bg-gray-200 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 md:hover:bg-transparent md:border-0 md:hover:text-sky-500"
        {@rest}
      >
