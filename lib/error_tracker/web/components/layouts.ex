    ...
    <nav class="border-b border-gray-200 bg-white dark:border-b-0 dark:bg-gray-900">
      <div class="container flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-main">
          <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-200 bg-gray-50 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:border-gray-400 dark:bg-gray-900 md:dark:bg-gray-800">
  ...
  def theme_switcher(assigns) do
    ...
    <li>
      <button
        type="button"
        title="Toggle theme"
        class={["w-full text-left", navbar_item_class()]}
