defmodule ErrorTracker.Web.Layouts do
  ...
  def navbar(assigns) do
    ~H"""
    <nav class="border-gray-400 bg-gray-900 light:border-gray-300 light:bg-gray-100">
      <div class="container flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button
          type="button"
          class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm rounded -lg md:hidden focus:outline-none focus:ring-2 text-gray-400 hover:bg-gray-700 focus:ring-gray-500 light:text-gray-500 light:hover:bg-gray-200 light:focus:ring-gray-300"
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-main">
          <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-400 bg-gray-900 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-gray-800 light:border-gray-300 light:bg-white light:md:bg-gray-100">
            ...
            <li>
              ...
              >
                ...
                <svg
                  ...
                  fill="currentColor"
                  aria-hidden="true"
                  class="w-5 h-5 hidden light:block"
                >
  ...
  defp navbar_item_class do
    [
      "whitespace-nowrap flex-0 block py-2 px-3 rounded-lg text-white hover:text-white hover:bg-gray-700 md:hover:bg-transparent md:border-0 md:hover:text-sky-500",
      "light:text-gray-900 light:hover:text-gray-900 light:hover:bg-gray-200 light:md:hover:bg-transparent light:md:hover:text-sky-600"
    ]
  end
end
