defmodule ErrorTracker.Web.CoreComponents do
  ...
  def button(%{type: "link"} = assigns) do
    ...
    <.link
      class={[
        ...
        "text-sm font-semibold text-sky-600 hover:text-sky-800",
        "dark:text-sky-500 dark:hover:text-white/80",
        @class
      ]}
      {@rest}
    >
  ...
  def badge(assigns) do
    color_class =
      case assigns.color do
        ...
        :red ->
          "bg-red-50 text-red-700 ring-red-600/10 dark:bg-red-400/10 dark:text-red-300 dark:ring-red-400/20"
  ...
  def pagination(assigns) do
    ...
    <div class="mt-10 w-full flex">
      <button
        :if={@page > 1}
        class="flex items-center justify-center px-4 h-10 text-base font-medium text-gray-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:bg-gray-900 dark:border-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
