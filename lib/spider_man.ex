defmodule SpiderMan do
  ...
  * [ItemProcessor](SpiderMan.Component.ItemProcessor.html): Store items.
  ...
  @doc """
  fetch spider's throughput info of each component,
  handy for displaying throughput info on Livebook
  """
  @spec throughput(spider | stats_tid :: :ets.tid()) :: [component_throughput_info :: map]
