defmodule ObanEvents do
  ...
  Define your events in one module:
      ...
      defmodule MyApp.Events do
        ...
        @events %{
          user_created: [
            {MyApp.EmailHandler, priority: 0, max_attempts: 10},
  ...
  - Handlers can be atoms (use defaults) or tuples with options: `{Handler, priority: 0, max_attempts: 10, queue: :critical, tags: ["urgent"]}`
  ...
  defmacro __using__(opts) do
    ...
    # - keyword list or nil (defaults to Oban module)
      ...
      def emit(event_name, data, opts \\ []) when is_atom(event_name) and is_map(data) do
        ...
        jobs =
          Enum.map(handlers, fn handler_spec ->
            ...
            job_opts = Keyword.merge(@oban_opts, handler_opts)
