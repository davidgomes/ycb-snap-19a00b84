defmodule ObanEvents do
  ...
  Any option accepted by `Oban.Job.new/2` (e.g. `:unique`, `:schedule_in`) can be given.
  ...
  Per-handler options (merged over globals):
  ...
  defmacro __using__(opts) do
    ...
    job_opts = Keyword.merge(@default_oban_opts, oban_opts)
