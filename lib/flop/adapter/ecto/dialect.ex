defmodule Flop.Adapter.Ecto.Dialect do
  ...
  # Postgres puts NULLs last when sorting by plain ASC/DESC. MySQL and SQLite
  # put NULLs first ascending and last descending instead.
  ...
  @doc """
  Returns where an order direction sorts `NULL` values.
  """
  ...
  def null_placement(%__MODULE__{nulls_last_ascending?: true}, :desc), do: :first
