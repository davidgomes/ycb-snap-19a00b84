defmodule Flop.Adapter.Ecto.Dialect do
  ...
  # PostgreSQL sorts NULL as larger than any value, so plain ASC puts NULLs last
  # and plain DESC puts them first. MySQL and SQLite sort NULL as smaller than
  # any value.
  ...
  @doc """
  Returns whether NULLs come before all other values when sorting in the given
  direction.
  """
