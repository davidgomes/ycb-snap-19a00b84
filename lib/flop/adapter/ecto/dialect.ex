defmodule Flop.Adapter.Ecto.Dialect do
  ...
  # Postgres puts nulls last when sorting by ASC or DESC without a nulls
  # classifier. MySQL and SQLite put nulls first.
  ...
  @doc """
  Returns whether an order direction sorts `NULL` values first or last.
  """
