defmodule Flop.Adapter.Ecto do
  ...
  defp cursor_dynamic([{direction, _, _, _} | _], %Dialect{adapter: nil})
    ...
    Flop determines where the database sorts NULL values from the repo's
    Ecto adapter, but no repo is configured.
    ...
    Alternatively, use the order directions :asc_nulls_first or
    :asc_nulls_last, and :desc_nulls_first or :desc_nulls_last.
    """
  end
