defmodule Hammer do
  ...
  @typedoc """
  The identifier of what is being rate limited.

  The built-in ETS and Atomic backends accept any term as a key. Other backends
  may be more restrictive, for example the Redis backend requires string keys.
  """
  @type key :: term
