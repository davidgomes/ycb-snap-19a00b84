defmodule Sentry.Telemetry.Scheduler do
  ...
  defp drain_rate_limited(state, category) do
    ...
    cond do
      ...
      # Transactions carry spans, and logs and metrics carry a byte size, so pass
      # the actual structs through the list-based recorder to also record the
      # discarded "span" and "log_byte"/"trace_metric_byte" outcomes.
