defmodule Sentry.Telemetry.Scheduler do
  ...
  defp drain_rate_limited(state, category) do
    ...
    cond do
      ...
      # Transactions carry spans and logs/metrics are also reported by size, so
      # pass the actual structs through the list-based recorder to also record
      # the discarded "span" and byte-size outcomes.
