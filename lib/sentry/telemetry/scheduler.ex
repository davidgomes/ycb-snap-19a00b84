defmodule Sentry.Telemetry.Scheduler do
  ...
  defp drain_rate_limited(state, category) do
    ...
    cond do
      ...
      # Transactions carry spans, and logs and metrics are also reported by size,
      # so pass the actual structs through the list-based recorder to also record
      # the discarded "span", "log_byte", and "trace_metric_byte" outcomes.
