defmodule PetalComponents.Dropdown do
  ...
  attr :id, :string,
    default: nil,
    doc: "id of the root the PetalDropdown hook mounts on. Autogenerated when omitted"
  ...
  The menu opens downward. With the bundled hooks registered, `PetalDropdown`
  flips it above the trigger when the viewport has no room below and more room
  above, and caps the height so items scroll inside the viewport. Without the
  hook the menu still opens, always downward.
  """
  def dropdown(assigns) do
    ...
    assigns = assign(assigns, :id, assigns.id || "#{assigns.options_container_id}-root")
