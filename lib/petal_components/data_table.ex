defmodule PetalComponents.DataTable do
  ...
  def data_table(assigns) do
    ...
    # link mode: URL wiring. Either mode: the hook closes an open filter
    # popover after Apply, and selection's tri-state header checkbox needs
    # its indeterminate property set. Menus stay in the page (anchored
    # popovers) so they scroll with the table instead of chasing the viewport.
    hooked? =
