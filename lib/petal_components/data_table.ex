defmodule PetalComponents.DataTable do
  ...
  def data_table(assigns) do
    ...
    # link mode: URL wiring. Selection's tri-state header checkbox needs
    # its indeterminate property set.
    hooked? =
      (link_mode? and (assigns.searchable or filter_cols != [] or assigns.page_size_options != [])) or
        assigns.selectable
  ...
  # in event mode, the form submits through its phx-submit - the popover
  # closes via phx-click-away / Escape like other anchored popovers
