defmodule PetalComponents.DataTable do
  ...
  def data_table(assigns) do
    ...
    hooked? =
      (link_mode? and (assigns.searchable or assigns.page_size_options != [] or filter_cols != [])) or
        assigns.selectable
  ...
  # event mode pushes the form directly; the popover closes on click-away or Escape
