defmodule PetalComponents.DataTable do
  ...
  def data_table(assigns) do
    ...
    # (CSS-anchored) panels the hook closes after an Apply, and selection's
  ...
  # event mode pushes the form; the hook closes the in-page popover on
  # submit (display: none + aria-expanded, same as click-away)
