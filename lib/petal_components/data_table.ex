defmodule PetalComponents.DataTable do
  ...
  def data_table(assigns) do
    ...
    # link mode: URL wiring. Either mode: the hook closes in-page filter
    # menus after an Apply, and selection's tri-state header checkbox
    # needs its indeterminate property set.
    hooked? =
  ...
  # event mode pushes the form; the hook hides the in-page menu on submit
