defmodule Phoenix.LiveViewTest.UploadClient do
  ...
  defp do_chunk(state, from, entry, proxy_pid, element, percent) do
    ...
    receive do
      ...
      # like the JS client, a server writer failure is not reported as a client error,
      # the channel closes and the caller is released once this client stops
  ...
  # entries rejected during preflight or join remain as {:error, reason} without a channel
