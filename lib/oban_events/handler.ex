defmodule ObanEvents.Handler do
  ...
  The second argument is an `ObanEvents.Event` struct carrying the event data
  along with its metadata (event ID, emission time, custom metadata, job ID, and attempt).
