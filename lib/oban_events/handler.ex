defmodule ObanEvents.Handler do
  ...
  ## Implementing a Handler
      ...
      defmodule MyApp.UserHandler do
        ...
        @impl true
        def handle_event(:user_created, %ObanEvents.Event{data: data, metadata: _meta}) do
  ...
  - `event`: `ObanEvents.Event` with `data`, `metadata`, `id`, `causation_id`,
    `correlation_id` and `emitted_at`
