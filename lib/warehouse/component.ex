defmodule Warehouse.Component do
  ...
  @doc """
  Starts a `Warehouse.GenServers.Component` process for every component in the
  ...
  def warmup_components() do
    for component <- Repo.all(Schemas.Component) do
      DynamicSupervisor.start_child(@supervisor, {Warehouse.GenServers.Component, [component: component]})
    end
