defmodule Warehouse.Sku do
  ...
  alias Warehouse.{AdditiveMap, Component, Repo, Schemas}
  ...
  @doc """
  Starts a `Warehouse.GenServers.Sku` process for every SKU in the database.
  ...
  def warmup_skus() do
    for sku <- Repo.all(Schemas.Sku) do
      DynamicSupervisor.start_child(@supervisor, {Warehouse.GenServers.Sku, sku})
    end
