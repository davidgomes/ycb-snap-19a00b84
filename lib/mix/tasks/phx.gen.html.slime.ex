defmodule Mix.Tasks.Phx.Gen.Html.Slime do
  ...
  The context and schema generation can be skipped with `--no-context` and
  `--no-schema`. Read the documentation for `phx.gen.html` for more
  information on the other options, such as `--web`, `--table`,
  `--binary-id` and `--context-app`.
  """
  use Mix.Task
  ...
  defp prompt_for_conflicts(context) do
    (phoenix_files(context) ++ slime_files(context) ++ context_files(context))
