defmodule EctoJob.Supervisor do
  ...
  def start_link(
    ...
    {notification_children, notifier_name} =
      case repo.__adapter__() do
        ...
        _ ->
          # Other adapters (e.g. MyXQL) don't support LISTEN/NOTIFY, so the
          # Producer will rely solely on polling to discover new jobs.
          {[], nil}
      end
