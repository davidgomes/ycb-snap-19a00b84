defmodule ObanChore.Plugin do
  ...
  ## Options
    ...
    * `:chores` - An explicit list of chore modules. Required unless `:otp_app` is set.
      Cannot be combined with `:otp_app`. Useful when discovery should be limited to known
      modules, including in tests.
