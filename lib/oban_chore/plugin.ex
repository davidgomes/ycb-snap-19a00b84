defmodule ObanChore.Plugin do
  ...
  ## Options
    ...
    * `:chores` - A list of chore modules to register explicitly. Useful in tests, or when you
      want to skip application scanning.
    * `:pubsub_server` - (Required) The name of your application's Phoenix PubSub server.

  Exactly one of `:otp_app` or `:chores` must be set.
  ...
  # Or register a specific list of chores (also handy in tests):
  plugins: [
