defmodule ObanChore.Plugin do
  ...
  ## Options
    ...
    * `:chores` - A list of chore modules to register explicitly, instead of scanning an OTP app.
      Required unless `:otp_app` is set. Cannot be combined with `:otp_app`.
      Useful when discovery is impractical, including tests.
  ...
  # Or pass an explicit list of chore modules:
  config :my_app, Oban,
    repo: MyApp.Repo,
    plugins: [
