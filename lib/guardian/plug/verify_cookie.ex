if Code.ensure_loaded?(Plug) do
  defmodule Guardian.Plug.VerifyCookie do
    ...
    * `:secret` - The secret used to verify the cookie token and sign the exchanged
      token. Accepts any value valid for the token module, or a one argument
      function that is called with the connection to select the secret. See
