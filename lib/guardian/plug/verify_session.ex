if Code.ensure_loaded?(Plug) do
  defmodule Guardian.Plug.VerifySession do
    ...
    * `:secret` - The secret used to verify the token. Accepts any value valid for
      the token module, or a one argument function that is called with the
      connection to select the secret. See `Guardian.Plug.resolve_secret/2`.
