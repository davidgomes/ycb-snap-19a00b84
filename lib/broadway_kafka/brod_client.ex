    ...
    with {:ok, hosts} <- validate(opts, :hosts, required: true),
      ...
      {:ok,
       %{
         ...
         shared_client_id: build_shared_client_id(shared_client, opts, client_config)
       }}
    end
  end
