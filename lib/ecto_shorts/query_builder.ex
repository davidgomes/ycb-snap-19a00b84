defmodule EctoShorts.QueryBuilder do
  ...
  @callback create_schema_filter(accumulator_query, filter_key, filter_value) :: Ecto.Query.t

  @spec create_schema_filter(module, accumulator_query, filter_key, filter_value) :: Ecto.Query.t
