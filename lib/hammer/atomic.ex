defmodule Hammer.Atomic do
  ...
  defp clean_fix_window(config) do
    ...
    maybe_invoke_before_clean(config, expired_terms)
  ...
  defp maybe_invoke_before_clean(%{before_clean: nil}, _expired_terms), do: :ok
  defp maybe_invoke_before_clean(_config, []), do: :ok

  defp maybe_invoke_before_clean(config, expired_terms) do
