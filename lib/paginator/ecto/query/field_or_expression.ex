defmodule Paginator.Ecto.Query.FieldOrExpression do
  ...
  def field_or_expr_is_nil(%{column: {_, handler}} = args) do
  ...
  def field_or_expr_equal(%{column: {_, handler}, value: value} = args) do
  ...
  def field_or_expr_less(%{column: {_, handler}, value: value} = args) do
    dynamic([{query, args.entity_position}], ^handler.() < ^value)
  end
  ...
  def field_or_expr_greater(%{column: {_, handler}, value: value} = args) do
    dynamic([{query, args.entity_position}], ^handler.() > ^value)
  end
