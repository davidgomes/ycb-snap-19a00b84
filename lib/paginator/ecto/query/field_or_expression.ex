defmodule Paginator.Ecto.Query.FieldOrExpression do
  ...
  def field_or_expr_is_nil(args = %{column: {_, handler}}) do
  ...
  def field_or_expr_equal(args = %{column: {_, handler}, value: value}) do
  ...
  def field_or_expr_less(args = %{column: {_, handler}, value: value}) do
    dynamic([{query, args.entity_position}], ^handler.() < ^value)
  end
  ...
  def field_or_expr_greater(args = %{column: {_, handler}, value: value}) do
    dynamic([{query, args.entity_position}], ^handler.() > ^value)
  end
