defmodule Paginator.Ecto.Query do
  ...
  defp get_operator(direction, :before) when direction in @asc_directions, do: :lt
  defp get_operator(direction, :before) when direction in @desc_directions, do: :gt
  defp get_operator(direction, :after) when direction in @asc_directions, do: :gt
  defp get_operator(direction, :after) when direction in @desc_directions, do: :lt

  defp get_operator(direction, _),
    do:
      raise(
        "Invalid sorting value :#{direction}, please use one of " <>
          inspect(@asc_directions ++ @desc_directions)
      )
