defmodule ObanChore do
  ...
  Returns a list of `%Oban.Job{}` structs, ordered by `id` descending by default, with the state converted to an atom.

  Supported `sort_by` values are `:id`, `:state`, `:started_at`, and `:timestamp`.
